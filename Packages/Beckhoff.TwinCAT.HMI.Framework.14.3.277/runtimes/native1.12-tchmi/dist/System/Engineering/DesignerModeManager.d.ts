import type { CompileResult } from '../ControlManager.js';
export declare class DesignerModeManager {
     ...
     */
    createControl(targetParentControl: string, domPos: number, controlHtml: string, attachCallback?: null | ((this: DesignerModeManager, data: TcHmi.IResultObject) => void)): CompileResult<TcHmi.Controls.System.baseTcHmiControl>;
    /**
