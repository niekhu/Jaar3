...
declare class TcHmiThemeSelect extends TcHmi.Controls.System.TcHmiControl {
    #private;
    ...
    protected __themeChangeEventDestroyFunction: TcHmi.DestroyFunction | null;
    /** Config changed event destroy function */
    protected __onThemeDefinitionChangedDestroyFunction: TcHmi.DestroyFunction | null;
    /** User interaction finished event destroy function */
    protected __userInteractionFinishedEventDestroyFunction: TcHmi.DestroyFunction | null;
     ...
     */
    protected __onThemeChanged(event: TcHmi.EventProvider.Event): void;
    /**
...
export { TcHmiThemeSelect as Control };
declare const _TcHmiThemeSelect: typeof TcHmiThemeSelect;
type tTcHmiThemeSelect = TcHmiThemeSelect;
declare global {
    namespace TcHmi.Controls.Beckhoff {
        const TcHmiThemeSelect: typeof _TcHmiThemeSelect;
        type TcHmiThemeSelect = tTcHmiThemeSelect;
    }
}
