 ...
 */
declare class TcHmiCombobox<T extends any = any, D extends ListItemGeneric<T>[] | T[] | TcHmi.Dictionary<T> = ListItemGeneric<T>[] | T[] | TcHmi.Dictionary<T>> extends TcHmiControl.Control {
    #private;
...
//# sourceMappingURL=TcHmiCombobox.esm.d.ts.map