...
import * as TcHmiDatagrid from '../TcHmiDatagrid/TcHmiDatagrid.esm.js';
declare class TcHmiTreeView extends TcHmiControl.Control {
    #private;
     ...
     */
    protected __dataSchema: TcHmi.JsonSchema | null | undefined;
    ...
    protected __dataSymbolSchema: TcHmi.JsonSchema | null | undefined;
    ...
    protected __pagingInfo: {
        ...
        filterMap: TcHmi.HierarchicalFilterMap[];
        timing: {
            isScrolling: boolean;
    ...
    /** Internal reference to the attribute "data-tchmi-filter-strategy" */
    protected __filterStrategy: TcHmi.FilterInstance.Strategy | undefined;
    ...
    protected __internalColumns: (Column | SimpleColumn)[];
    ...
    protected __headerHeightUnit: TcHmi.DimensionUnit | undefined;
    ...
    protected __rowNumbersWidthUnit: TcHmi.DimensionUnit | undefined;
    ...
    protected __headerFontFamily: TcHmi.FontFamily | null | undefined;
    protected __headerFontSize: number | undefined;
    protected __headerFontSizeUnit: TcHmi.FontSizeUnit | undefined;
    protected __headerFontStyle: TcHmi.FontStyle | undefined;
    protected __headerFontWeight: TcHmi.FontWeight | undefined;
    protected __gridFontFamily: TcHmi.FontFamily | null | undefined;
    protected __gridFontSize: number | undefined;
    protected __gridFontSizeUnit: TcHmi.FontSizeUnit | undefined;
    protected __gridFontStyle: TcHmi.FontStyle | undefined;
    protected __gridFontWeight: TcHmi.FontWeight | undefined;
    protected __rowNumbersFontFamily: TcHmi.FontFamily | null | undefined;
    protected __rowNumbersFontSize: number | undefined;
    protected __rowNumbersFontSizeUnit: TcHmi.FontSizeUnit | undefined;
    protected __rowNumbersFontStyle: TcHmi.FontStyle | undefined;
    protected __rowNumbersFontWeight: TcHmi.FontWeight | undefined;
    /**
    ...
    protected __timePickerConfirmedEventDestroyer: TcHmi.DestroyFunction | null;
    protected __timePickerCanceledEventDestroyer: TcHmi.DestroyFunction | null;
    ...
    protected __flatData: FlatData[];
    protected __expandedElements: ExpandedElement[];
    protected __lastExpandedOrCollapsed: number[] | null;
    ...
    protected __visibilityChangedDestroyEvent: TcHmi.DestroyFunction | null;
    protected __comboboxDropdowns: TcHmi.Dictionary<HTMLElement>;
    ...
    protected __storage: TcHmi.LocalStorage<{
        ...
        sorting: ReturnType<TcHmiDatagrid.Control['getSorting']>;
        columnWidths: string[];
    }> | undefined;
    ...
    /**
     * Retrieves path indices in the hierarchical structure of the TreeView.
     * @param pathString Specifies the path to locate.
     * @param columnName Column name to match path segments.
     * @param allowIncompletePath Returns indices for a partial path match.
     * @returns Indices of the path, or `null` if not fully matched without `allowIncompletePath`.
     */
    getIndexOfPath(pathString: string, columnName: string, allowIncompletePath?: boolean): number[] | null;
    protected __getIndicesOfPathRecursive(children: any[], path: TcHmi.ObjectPath, pathIndices: number[], columnName: string): boolean;
    /**
    ...
    /**
     * A function to get an element in a hierarchical data structure by the hierarchical index.
     ...
     */
    protected __dataToFilteredSortMap(data: TcHmiDatagrid.PagedArray<any> | any[], index?: number[]): TcHmi.HierarchicalFilterMap[];
    /**
    ...
    /**
     * Converts the filterSortMap Structure in a flat array containing the original indexed of the elements.
     * Only respects top level elements and the childs of expanded elements.
     * @param data The data Array.
     * @param flatData The which will be filled.
     */
    protected __fillFlatDataWithFilterSortMap(data: TcHmi.HierarchicalFilterMap[], flatData: FlatData[]): void;
    /**
     * Converts the data Structure in a flat array containing the original indexed of the elements.
     * Only respects top level elements and the childs of expanded elements.
     * @param data The data Array.
     ...
     */
    protected __fillFlatDataWithData(data: TcHmiDatagrid.PagedArray<any> | any, flatData: FlatData[], previousIndex?: number[]): void;
    /**
     ...
     */
    protected __getEditorInfoByOriginalIndexAndPropertyName(editorInfo: TcHmi.Controls.Helpers.Editor.EditorInfo | undefined, index: number[], propertyName: string): TcHmi.Controls.Helpers.Editor.EditorInfo | undefined;
    /**
     * Get the Editor Info of a specific object and property by the hierarchical index and property name
     * @param editorInfo base editor info
     * @param index The hierarchical index
     * @param propertyName The property name
     */
    protected __getEditorInfoByOriginalIndex(editorInfo: TcHmi.Controls.Helpers.Editor.EditorInfo | undefined, index: number[]): TcHmi.Controls.Helpers.ObjectEditor.Info | undefined;
    /**
     * Get the editorInfo of an optionalEditor if the parameter is an optionalEditor
     * @param editorInfo
     */
    protected __removeOptionalEditorLayer(editorInfo: TcHmi.Controls.Helpers.Editor.EditorInfo | undefined): TcHmi.Controls.Helpers.BooleanEditor.Info | TcHmi.Controls.Helpers.NumberEditor.Info | TcHmi.Controls.Helpers.StringEditor.Info | TcHmi.Controls.Helpers.TimeEditor.Info | TcHmi.Controls.Helpers.EnumEditor.Info<any> | TcHmi.Controls.Helpers.ObjectEditor.Info | TcHmi.Controls.Helpers.ArrayEditor.Info | TcHmi.Controls.Helpers.TupleEditor.Info | TcHmi.Controls.Helpers.ChoiceEditor.Info | TcHmi.Controls.Helpers.NullEditor.Info | TcHmi.Controls.Helpers.InvalidEditor.Info | undefined;
    /**
     *
     * @param editorInfo
     */
    protected __getColumnControlInfoByEditorInfo(editorInfo: TcHmi.Controls.Helpers.Editor.EditorInfo | undefined): {
        columnControl: "TextBlock" | "TextBox" | "CheckBox" | "ComboBox" | "NumericInput" | "SpinboxInput" | "DateTimeInput" | "TimespanInput" | "HTMLElement";
        dataDefinitions: TcHmiDatagrid.DataDefinition | TcHmiDatagrid.DataDefinition[] | undefined;
        editable: boolean;
        schema: TcHmi.JsonSchema | undefined;
    };
    /**
     ...
     */
    protected __fillCell(elementCell: HTMLTableCellElement, internalColumn: Column | SimpleColumn, value: any, isPreparedValue?: boolean): void;
    /**
     ...
     */
    protected __modifyRadioButton(row: number[], column: number, rowElement?: HTMLElement, forceWrite?: boolean, symbolWriteCallback?: (data: TcHmi.IErrorDetails | null) => void): {
     ...
     * @param dataDefinitions The dataDefintions for the spinbox.
     * @param data The current row data.
     * @param targetButton The button that was interacted with.
     */
    protected __useSpinbox(columnDefinition: Column | SimpleColumn, dataDefinitions: TcHmiDatagrid.DataDefinition | TcHmiDatagrid.DataDefinition[] | undefined, data: any, inputElement: HTMLInputElement, targetButton: HTMLElement): number | null;
    /**
     ...
     * @param dataDefinitions The dataDefintions for the date time input.
     ...
     */
    protected __useDateTimePicker(columnDefinition: Column | SimpleColumn, dataDefinitions: TcHmiDatagrid.DataDefinition | TcHmiDatagrid.DataDefinition[] | undefined, dataRow: number[], inputElement: HTMLInputElement, buttonElement: HTMLElement, cellElement: HTMLElement): void;
    /**
     * Get the hierarchical schema formatMaximum of the selected timespanPicker.
     * @param schema The current hierarchical schema of the dataSymbol based on the depth.
     * @param dataRowLength The current hierarchical depth (the smaller the deeper).
     * @returns The current formatMaximum of the selected timespanPicker.
     */
    protected __getHierarchicalSchema(schema: TcHmi.JsonSchema | null | undefined, dataRow: number[] | undefined, columnDefinition: Column | SimpleColumn): string | undefined;
    /**
     ...
     * @param dataDefinitions The dataDefintions for the timespan input.
     * @param srcDataRow The index of the current row in the source data.
     ...
     */
    protected __useTimespanPicker(columnDefinition: Column | SimpleColumn, dataDefinitions: TcHmiDatagrid.DataDefinition | TcHmiDatagrid.DataDefinition[] | undefined, dataRow: number[], inputElement: HTMLInputElement, buttonElement: HTMLElement, cellElement: HTMLElement): void;
    /**
     ...
     */
    protected __modifyData(valueNew: any, row: number[], column: number, rowElement?: HTMLElement, forceWrite?: boolean, symbolWriteCallback?: (data: TcHmi.IErrorDetails | null) => void): {
        convertedValue: any;
        needSorting: boolean;
    } | null;
    /**
     ...
     */
    protected __writeObjectProperty(obj: TcHmi.Dictionary<any>, path: string, valueNew: any): void;
    /**
     ...
     */
    setColumns(valueNew: Column[] | SimpleColumn | null): void;
    /**
     * The watch callback for the columns object resolver.
     */
    protected __onResolverForColumnsWatchCallback(data: TcHmi.Symbol.ObjectResolver.IWatchResultObject<Column[] | SimpleColumn>): void;
    /**
     * Returns the current value of the member variable text.
     * @returns the current value of the member variable text.
     */
    getColumns(): SimpleColumn | Column[] | undefined;
    /**
    ...
    /**
     * Generates a json schema based on the information of the value and the dataDefinition.
     */
    protected __generateSchemaByDataDefintions(value: any, columnDefinition?: Column | SimpleColumn): TcHmi.JsonSchema;
    /**
     ...
     * @returns the current value of the member variable dataSchema.
     */
    getDataSchema(): TcHmi.JsonSchema | null | undefined;
    /**
     ...
     */
    protected __onDataSymbolPage(data: TcHmi.Server.IResultObject<unknown, any[]>): void;
    /**
     ...
     */
    protected __onResolverForSortingWatchCallback(data: TcHmi.Symbol.ObjectResolver.IWatchResultObject<TcHmiDatagrid.SortingInfo[]>): void;
    /**
    ...
    /**
     * Sets the value of filterStrategy
     * @param valueNew The new value for filterStrategy
     */
    setFilterStrategy(valueNew: TcHmi.FilterInstance.Strategy | keyof typeof TcHmi.FilterInstance.Strategy | null): void;
    /**
     * Gets the value of FilterStrategy
     * @returns The current value of FilterStrategy
     */
    getFilterStrategy(): import("Beckhoff.TwinCAT.HMI.Framework/dist/API/FilterInstance.js").Strategy | undefined;
    /**
     * Processes FilterStrategy
     */
    protected __processFilterStrategy(): void;
    /**
     ...
     */
    protected __onResolverForHeaderCellPaddingWatchCallback(data: TcHmi.Symbol.ObjectResolver.IWatchResultObject<TcHmi.FourSidedCss>): void;
    /**
     ...
     */
    protected __onResolverForTableBorderColorWatchCallback(data: TcHmi.Symbol.ObjectResolver.IWatchResultObject<TcHmi.SolidColor>): void;
    /**
     ...
     */
    protected __onResolverForTableBorderStyleWatchCallback(data: TcHmi.Symbol.ObjectResolver.IWatchResultObject<TcHmi.BorderStyle>): void;
    /**
     ...
     */
    protected __onResolverForRowNumbersCellPaddingWatchCallback(data: TcHmi.Symbol.ObjectResolver.IWatchResultObject<TcHmi.FourSidedCss>): void;
    /**
     ...
     */
    protected __onResolverForCellContentPaddingWatchCallback(data: TcHmi.Symbol.ObjectResolver.IWatchResultObject<TcHmi.FourSidedCss>): void;
    /**
     ...
     */
    protected __onResolverForHeaderBackgroundColorWatchCallback(data: TcHmi.Symbol.ObjectResolver.IWatchResultObject<TcHmi.Color>): void;
    /**
     ...
     */
    protected __onResolverForHeaderTextColorWatchCallback(data: TcHmi.Symbol.ObjectResolver.IWatchResultObject<TcHmi.SolidColor>): void;
    /**
     ...
     */
    protected __onResolverForRowNumbersTextColorWatchCallback(data: TcHmi.Symbol.ObjectResolver.IWatchResultObject<TcHmi.SolidColor>): void;
    /**
     ...
     */
    protected __onResolverForRowNumbersBackgroundColorWatchCallback(data: TcHmi.Symbol.ObjectResolver.IWatchResultObject<TcHmi.Color>): void;
    /**
     ...
     * The watch callback for the rowNumbersBackgroundColor object resolver
     */
    protected __onResolverForSelectedRowIndexWatchCallback(data: TcHmi.Symbol.ObjectResolver.IWatchResultObject<number[]>): void;
    /**
...
declare const enum UpdateTableType {
    dataChange = 0,
    configChange = 1,
    scroll = 2
}
export interface IControlSpecificData extends TcHmiControl.IControlSpecificData {
    'Controls.Beckhoff.TcHmiTreeView.triggerProcessUnitSize': boolean;
}
...
export type ColumnControl = 'TextBlock' | 'TextBox' | 'CheckBox' | 'ComboBox' | 'Image' | 'PasswordInput' | 'NumericInput' | 'SpinboxInput' | 'DateTimeInput' | 'TimespanInput' | 'Button' | 'ToggleButton' | 'ToggleSwitch' | 'RadioButton' | 'HTMLElement' | 'AutoDetectControl';
...
/** The meta data of the value passed to the format function */
export interface ValueMetaData {
    schema: TcHmi.JsonSchema;
}
export { TcHmiTreeView as Control };
declare const _TcHmiTreeView: typeof TcHmiTreeView;
type tTcHmiTreeView = TcHmiTreeView;
type tIControlSpecificData = IControlSpecificData;
type tFlatData = FlatData;
type tExpandedElement = ExpandedElement;
type tCell = Cell;
type tSubscriptionData = SubscriptionData;
type tColumnControl = ColumnControl;
type tColumn = Column;
type tSimpleColumn = SimpleColumn;
type tUserInput = UserInput;
type tValueMetaData = ValueMetaData;
declare global {
    namespace TcHmi.Controls.Beckhoff {
        const TcHmiTreeView: typeof _TcHmiTreeView;
        type TcHmiTreeView = tTcHmiTreeView;
        namespace TcHmiTreeView {
            type IControlSpecificData = tIControlSpecificData;
            type FlatData = tFlatData;
            type ExpandedElement = tExpandedElement;
            type Cell = tCell;
            type SubscriptionData = tSubscriptionData;
            type ColumnControl = tColumnControl;
            type Column = tColumn;
            type SimpleColumn = tSimpleColumn;
            type UserInput = tUserInput;
            type ValueMetaData = tValueMetaData;
        }
    }
}
//# sourceMappingURL=TcHmiTreeView.esm.d.ts.map