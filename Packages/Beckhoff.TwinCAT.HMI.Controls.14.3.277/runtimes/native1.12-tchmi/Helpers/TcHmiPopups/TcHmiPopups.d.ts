...
declare namespace TcHmi.Controls.Helpers {
    abstract class ButtonsPrompt<T> extends Popup<T> {
        protected __buttons: Map<string, {
            value: T;
            button: TcHmi.Controls.Beckhoff.TcHmiButton;
        }>;
...
declare namespace TcHmi.Controls.Helpers {
    abstract class OkCancelPrompt<T, T2 = void> extends Popup<{
        ...
        protected __okButton: TcHmi.Controls.Beckhoff.TcHmiButton;
...
type TcHmiInput = import('../../dist/TcHmiInput/TcHmiInput.esm.js').Control;
declare namespace TcHmi.Controls.Helpers {
...
declare namespace TcHmi.Controls.Helpers {
    ...
    type TcHmiCheckbox = import('../../dist/TcHmiCheckbox/TcHmiCheckbox.esm.js').Control;
    type TcHmiTextbox = import('../../dist/TcHmiTextbox/TcHmiTextbox.esm.js').Control;
    type TcHmiDateTimeInput = import('../../dist/TcHmiDateTimeInput/TcHmiDateTimeInput.esm.js').Control;
    export class FilterPrompt extends Popup<Filter> {
        ...
        protected __groupInfo: {
            ...
            toGroup: (Comparison | TcHmi.Filter)[];
        } | null;
         ...
         * @param parentControl The control which owns the popup.
         */
        constructor(schema: JsonSchema | null, originalFilter: TcHmi.Filter, parentControl?: TcHmi.Controls.System.TcHmiControl | null);
        /**
         * Destroys the popup and all its controls.
         * @param force If true, child controls will be removed from the parent control before destruction, to ensure destruction in case of keepAlive === true.
         */
    ...
    export namespace FilterPopup {
        ...
        interface RowData {
            ...
            comparator: {
                ...
                control: TcHmiCombobox<string, TcHmiComboboxListItemGeneric<string>[]> | null;
                destroyer: TcHmi.DestroyFunction | null;
            };
            value: {
                cell: HTMLTableCellElement;
