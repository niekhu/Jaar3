declare namespace TcHmi.Controls.Helpers {
    type TcHmiTextblock = import('../../../dist/TcHmiTextblock/TcHmiTextblock.esm.js').Control;
    ...
    type TcHmiPasswordInput = import('../../../dist/TcHmiPasswordInput/TcHmiPasswordInput.esm.js').Control;
     ...
     */
    export class InteractiveWritePrompt extends OkCancelPrompt<TcHmi.UiProvider.PopupProvider.InteractiveWritePrompt.Value, TcHmi.UiProvider.PopupProvider.InteractiveWritePrompt.Value> {
        /**
        ...
        protected __editorNewValue: TcHmi.Controls.Helpers.Editor<any, Helpers.Editor.EditorInfo> | null;
        protected __editorPrevValue: TcHmi.Controls.Helpers.Editor<any, Helpers.Editor.EditorInfo> | null;
    ...
    export namespace InteractiveWritePrompt {
