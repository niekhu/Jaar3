...
declare namespace TcHmi.Controls.Helpers {
    ...
    namespace SchemaParser {
         ...
         * or oneOf is used. If the function returns null, the SchemaParser uses its own algorithm to generate a name.
         */
        function parse(schema: JsonSchema, nameGenerator: (editorType: Editor.EditorType, schemaTitle: string | undefined, schemaId: string | undefined, schemas: TcHmi.JsonSchema[]) => string | null): Editor.EditorInfo;
        /**
    ...
    namespace SchemaParser {
         ...
         */
        type NameGenerator = (editorType: Editor.EditorType, schemaTitle: string | undefined, schemaId: string | undefined, schemas: TcHmi.JsonSchema[]) => string | null;
...
declare namespace TcHmi.Controls.Helpers {
    ...
    abstract class Editor<T, I extends Editor.EditorInfo = Editor.EditorInfo> {
        ...
        readonly onChange: Readonly<{
            add: (callback: (editor: Editor<T, I>, state: Editor.State<T>) => void) => TcHmi.DestroyFunction;
        ...
        readonly onConfirm: Readonly<{
            add: (callback: (editor: Editor<T, I>, state: Editor.ValidState<T>) => void) => TcHmi.DestroyFunction;
...
declare namespace TcHmi.Controls.Helpers {
    type TcHmiButton = import('../../../dist/TcHmiButton/TcHmiButton.esm.js').Control;
    type TcHmiTimespanPicker = import('../../../dist/TcHmiTimespanPicker/TcHmiTimespanPicker.esm.js').Control;
    type TcHmiDateTimePicker = import('../../../dist/TcHmiDateTimePicker/TcHmiDateTimePicker.esm.js').Control;
    /**
     * Editor for strings in the date time or timespan format.
     */
    export class TimeEditor extends TextboxBasedEditor<string, TimeEditor.Info> {
...
declare namespace TcHmi.Controls.Helpers {
    type TcHmiComboboxListItemGeneric<T> = import('../../../dist/TcHmiCombobox/TcHmiCombobox.esm.js').ListItemGeneric<T>;
    type TcHmiCombobox<T extends any = any, D extends TcHmiComboboxListItemGeneric<T>[] | T[] | TcHmi.Dictionary<T> = TcHmiComboboxListItemGeneric<T>[] | T[] | TcHmi.Dictionary<T>> = import('../../../dist/TcHmiCombobox/TcHmiCombobox.esm.js').Control<T, D>;
    /**
     * Editor that is based on a combobox like for enums and booleans.
     */
    export abstract class ComboboxBasedEditor<T, I extends Editor.EditorInfo = Editor.EditorInfo> extends Editor<T, I> {
        protected __combobox: TcHmiCombobox<T, TcHmiComboboxListItemGeneric<T>[]>;
        /**
...
declare namespace TcHmi.Controls.Helpers {
     ...
     */
    export class ChoiceEditor extends Editor<any, ChoiceEditor.Info> {
        protected __value: any;
        protected __container: HTMLDivElement;
