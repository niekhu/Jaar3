...
declare namespace TcHmi.Controls.Helpers {
    class TreeBrowsingDisplay extends Display {
         ...
         * @param event The event to check.
         */
        protected __preprocessPointerEvent(event: PointerEvent): TreeBrowsingDisplay.PointerEvent;
        /**
         * Selects an item.
         * @param event The event containing information about the item to select. Use null to clear the selection.
         */
    ...
    namespace TreeBrowsingDisplay {
        type PointerEvent = RowEvent | ClearEvent | IgnoreEvent;
        interface RowEvent {
            type: 'Row';
            row: HTMLElement;
...
declare namespace TcHmi.Controls.Helpers {
    class DirectoryBrowser<TFile, TFolder> {
        ...
        onBeforePathChange: Readonly<{
            add: (callback: (newCurrentItem: DirectoryBrowser.Item<TFile, TFolder> | null, newPath: string[] | null, cancelable: boolean) => Promise<boolean>) => TcHmi.DestroyFunction;
        ...
        onBeforeSelectionChange: Readonly<{
            add: (callback: (newSelectedItems: DirectoryBrowser.DescendantItem<TFile, TFolder>[] | null, cancelable: boolean) => Promise<boolean>) => TcHmi.DestroyFunction;
        ...
        onSelectionChange: Readonly<{
            add: (callback: (selectedItems: DirectoryBrowser.DescendantItem<TFile, TFolder>[] | null) => void) => TcHmi.DestroyFunction;
        ...
        onSelectedItemUpdate: Readonly<{
            add: (callback: (selectedItem: DirectoryBrowser.DescendantItem<TFile, TFolder>) => void) => TcHmi.DestroyFunction;
        ...
        onPathChange: Readonly<{
            add: (callback: (currentItem: DirectoryBrowser.Item<TFile, TFolder> | null, path: string[] | null) => void) => TcHmi.DestroyFunction;
        ...
        onCurrentItemUpdate: Readonly<{
            add: (callback: (currentItem: DirectoryBrowser.Item<TFile, TFolder>) => void) => TcHmi.DestroyFunction;
         ...
         * @param getMetadata A function that returns metadata about the given file or folder.
         */
        protected buildDirectoryTree(rootFolder: TFolder, getChildren: (folder: TFolder) => Map<string, TFile | TFolder>, isFile: (candidate: TFile | TFolder) => candidate is TFile, getMetadata?: (item: TFile | TFolder) => TcHmi.Dictionary<any>): DirectoryBrowser.Root<TFile, TFolder>;
    }
    namespace DirectoryBrowser {
        ...
        class Directory<TFile, TFolder> {
            ...
            /** Event handlers that are called before the path is changed. If the cancelable parameter is true, returning false from one of the handlers will cancel the path change. */
            onBeforePathChange: Readonly<{
                add: (callback: (newCurrentItem: Item<TFile, TFolder>, newPath: string[], cancelable: boolean) => Promise<boolean>) => TcHmi.DestroyFunction;
            ...
            /** Event handlers that are called before the selection is changed. If the cancelable parameter is true, returning false from one of the handlers will cancel the selection change. */
            onBeforeSelectionChange: Readonly<{
                add: (callback: (newSelectedItems: DescendantItem<TFile, TFolder>[], cancelable: boolean) => Promise<boolean>) => TcHmi.DestroyFunction;
            ...
            /** Event handlers that are called after the selection has changed. */
            onSelectionChange: Readonly<{
                add: (callback: (selectedItems: DescendantItem<TFile, TFolder>[]) => void) => TcHmi.DestroyFunction;
                remove: (callback: (selectedItems: DescendantItem<TFile, TFolder>[]) => void) => void;
            }>;
            private __onSelectedItemUpdateManager;
            /** Event handlers that are called when one of the selected items is updated. This happens when the payload or metadata of the item changes. */
            onSelectedItemUpdate: Readonly<{
                add: (callback: (selectedItem: DescendantItem<TFile, TFolder> | null) => void) => TcHmi.DestroyFunction;
                remove: (callback: (selectedItem: DescendantItem<TFile, TFolder> | null) => void) => void;
            }>;
            private __onPathChangeManager;
            /** Event handlers that are called after the path has changed. */
            onPathChange: Readonly<{
                add: (callback: (currentItem: Item<TFile, TFolder>, path: string[]) => void) => TcHmi.DestroyFunction;
                remove: (callback: (currentItem: Item<TFile, TFolder>, path: string[]) => void) => void;
            }>;
            private __onCurrentItemUpdateManager;
            /** Event handlers that are called when the current item is updated. This happens when the payload or metadata of the item changes. */
            onCurrentItemUpdate: Readonly<{
                add: (callback: (currentItem: Item<TFile, TFolder>) => void) => TcHmi.DestroyFunction;
            ...
            onDirectoryUpdate: Readonly<{
                add: (callback: (root: Root<TFile, TFolder>) => void) => TcHmi.DestroyFunction;
             ...
             */
            selectItem(item: DescendantItem<TFile, TFolder>, expandSelection: boolean, cancelable?: boolean): Promise<boolean>;
            /**
             ...
             * @param cancelable Controls whether this action should be cancelable by returning false in one of the beforeSelectionChange event handlers.
             */
            deselectItem(item: DescendantItem<TFile, TFolder>, cancelable?: boolean): Promise<boolean>;
            /**
