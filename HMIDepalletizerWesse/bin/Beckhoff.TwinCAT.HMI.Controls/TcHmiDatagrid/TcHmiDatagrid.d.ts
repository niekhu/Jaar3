...
declare class TcHmiDatagrid extends TcHmi.Controls.System.TcHmiControl {
    #private;
    ...
    protected __destroyOnVisibilityChanged: TcHmi.DestroyFunction | null;
     ...
     * @param symbolWriteCallback The callback function handling the symbol write response.
     */
    protected __modifySrcData(valueNew: any, row: number, column: number, rowElement?: HTMLElement, forceWrite?: boolean, symbolWriteCallback?: (data: TcHmi.IErrorDetails | null) => void): {
        convertedValue: any;
        needSorting: boolean;
    } | null;
    /**
     ...
     */
    protected __onResolverForSrcColumnWatchCallback(data: TcHmi.Symbol.ObjectResolver.IWatchResultObject<Column[] | SimpleColumn>): void;
    /**
     ...
     */
    protected __onResolverForSrcDataWatchCallback(data: TcHmi.Symbol.ObjectResolver.IWatchResultObject<any[]>): void;
    /**
     ...
     */
    protected __onResolverForSortingWatchCallback(data: TcHmi.Symbol.ObjectResolver.IWatchResultObject<SortingInfo[]>): void;
    /**
...
export type SortingInfo = TcHmi.SortingInfo;
