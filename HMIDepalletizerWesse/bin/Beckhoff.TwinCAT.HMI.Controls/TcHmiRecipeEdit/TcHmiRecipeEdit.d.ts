...
declare class TcHmiRecipeEdit extends TcHmi.Controls.System.TcHmiControl {
    #private;
    /**
     * Constructor
     * @param element
    ...
    protected __onRecipeListReceivedManager: TcHmi.Controls.Helpers.CallbackManager<(rootDirectory: TcHmi.Server.RecipeManagement.FolderRecipe | null) => void>;
    ...
    protected __clipboard: {
        action: 'cut' | 'copy';
        origin: string[];
        items: TcHmi.Controls.Helpers.DirectoryBrowser.DescendantItem<TcHmi.Server.RecipeManagement.Recipe, TcHmi.Server.RecipeManagement.FolderRecipe>[];
    } | null;
    ...
    protected __treeBrowsingDisplay?: TcHmi.Controls.Helpers.TreeBrowsingDisplay;
    protected __recipeEditor: RecipeEditor | undefined;
    protected __namePrompt: TcHmi.Controls.Helpers.InputPrompt | null;
    ...
    protected __activatePrompt: TcHmi.Controls.Helpers.TextAndButtonsPrompt<'saveAndActivate' | 'justActivate' | 'cancel'> | null;
    protected __teachErrorPopup: TcHmi.Controls.Helpers.TextAndButtonsPrompt<void> | null;
    protected __confirmClosePrompt: TcHmi.Controls.Helpers.TextAndButtonsPrompt<'save' | 'discard' | 'cancel'> | null;
     ...
     */
    protected __onSelectionChanged(selectedItems: TcHmi.Controls.Helpers.DirectoryBrowser.DescendantItem<TcHmi.Server.RecipeManagement.Recipe, TcHmi.Server.RecipeManagement.FolderRecipe>[] | null): void;
    /**
     * Handler for the beforePathChange event of the recipe browser.
     * @param currentItem The new current item.
     * @param path The new path.
     */
    protected __onBeforePathChange(newCurrentItem: TcHmi.Controls.Helpers.DirectoryBrowser.Item<TcHmi.Server.RecipeManagement.Recipe, TcHmi.Server.RecipeManagement.FolderRecipe> | null, newPath: string[] | null, cancelable: boolean): Promise<boolean>;
    /**
     * Handler for the pathChanged event of the recipe browser.
     * @param currentItem The new current item.
     * @param path The new path.
     */
    protected __onPathChanged(currentItem: TcHmi.Controls.Helpers.DirectoryBrowser.Item<TcHmi.Server.RecipeManagement.Recipe, TcHmi.Server.RecipeManagement.FolderRecipe> | null, path: string[] | null): void;
    /**
     ...
     */
    protected __getNamePrompt(headerKey: string): TcHmi.Controls.Helpers.InputPrompt;
    /**
     * Returns a TextAndButtonsPrompt with a yes and a no button.
     * @param headerKey The localization key for the header text.
     * @param contentKey The localization key for the content text.
     */
    protected __getConfirmationPrompt(headerKey: string, contentKey: string): TcHmi.Controls.Helpers.TextAndButtonsPrompt<boolean>;
    /**
     ...
     */
    protected __copyPaste(itemsToPaste: Map<string, TcHmi.Controls.Helpers.DirectoryBrowser.DescendantItem<TcHmi.Server.RecipeManagement.Recipe, TcHmi.Server.RecipeManagement.FolderRecipe>>, target: string[]): void;
    /**
     ...
     */
    protected __cutPaste(itemsToPaste: Map<string, TcHmi.Controls.Helpers.DirectoryBrowser.DescendantItem<TcHmi.Server.RecipeManagement.Recipe, TcHmi.Server.RecipeManagement.FolderRecipe>>, origin: string[], target: string[]): void;
    /**
     ...
     */
    protected __updateBrowsingButtons(selectedItems: TcHmi.Controls.Helpers.DirectoryBrowser.DescendantItem<TcHmi.Server.RecipeManagement.Recipe, TcHmi.Server.RecipeManagement.FolderRecipe>[] | null): void;
    /**
     ...
     */
    __registerOnRecipeListReceived(callback: (rootDirectory: TcHmi.Server.RecipeManagement.FolderRecipe | null) => void): TcHmi.DestroyFunction;
    /**
...
export declare class RecipeEditor {
    ...
    protected __editorFactory: TcHmi.Controls.Helpers.EditorFactory;
    protected __editors: Map<string, RecipeReferenceEditor | TcHmi.Controls.Helpers.Editor<any, TcHmi.Controls.Helpers.Editor.EditorInfo>>;
    ...
    protected readonly __onChangeManager: TcHmi.Controls.Helpers.CallbackManager<(editor: RecipeEditor) => void>;
    readonly onChange: Readonly<{
        add: (callback: (editor: RecipeEditor) => void) => TcHmi.DestroyFunction;
...
export interface LocalizableTexts {
    ...
    editorLocalizations: Partial<TcHmi.Controls.Helpers.Editor.LocalizableTexts>;
...
export declare class RecipeReferenceEditor {
    ...
    protected readonly __onChangeManager: TcHmi.Controls.Helpers.CallbackManager<(editor: RecipeReferenceEditor) => void>;
    readonly onChange: Readonly<{
        add: (callback: (editor: RecipeReferenceEditor) => void) => TcHmi.DestroyFunction;
...
export interface LocalizableTexts extends TcHmi.Controls.Helpers.OkCancelPrompt.LocalizableTexts {
...
export declare class CreateRecipePrompt extends TcHmi.Controls.Helpers.OkCancelPrompt<{
    name: string;
    recipeTypeName: string;
    recipeType: TcHmi.Server.RecipeManagement.RecipeType;
}> {
...
export declare class SelectRecipePrompt extends TcHmi.Controls.Helpers.OkCancelPrompt<{
    name: string;
    recipe: TcHmi.Server.RecipeManagement.Recipe;
}> {
    #private;
    protected __parentControl: TcHmi.Controls.System.TcHmiControl;
    protected __recipeBrowser: TcHmi.Controls.Helpers.DirectoryBrowser<TcHmi.Server.RecipeManagement.Recipe, TcHmi.Server.RecipeManagement.FolderRecipe>;
     ...
     * @param parentControl The control which owns the popup.
     */
    constructor(pathDisplay: TcHmi.Controls.Helpers.PathDisplay, parentControl: TcHmiRecipeEdit);
    /**
...
export declare class SelectRecipeTypePrompt extends TcHmi.Controls.Helpers.OkCancelPrompt<{
    name: string;
    recipeType: TcHmi.Server.RecipeManagement.RecipeType;
}> {
    #private;
    protected __parentControl: TcHmi.Controls.System.TcHmiControl;
    protected __recipeTypeBrowser: TcHmi.Controls.Helpers.DirectoryBrowser<TcHmi.Server.RecipeManagement.RecipeType, TcHmi.Server.RecipeManagement.FolderRecipeType>;
    protected __initialPath: string[] | null;
    protected __recipeManagementDomain: string | null;
     ...
     * @param parentControl The control which owns the popup.
     */
    constructor(pathDisplay: TcHmi.Controls.Helpers.PathDisplay, parentControl: TcHmi.Controls.System.TcHmiControl);
    /**
     * Handler for the PathChanged event of the recipe type browser.
     * @param currentItem The current item.
     * @param path The path to the current item.
     */
    protected __onPathChanged(currentItem: TcHmi.Controls.Helpers.DirectoryBrowser.Item<TcHmi.Server.RecipeManagement.RecipeType, TcHmi.Server.RecipeManagement.FolderRecipeType> | null, path: string[] | null): void;
    /**
     * Handler for the SelectionChanged event of the recipe type browser.
     * @param selectedItem The selected item, or null if nothing is selected.
     * @param path The current path.
     * @param selectedItemName The name of the selected item, or null if nothing is selected.
     */
    protected __onSelectionChanged(selectedItems: TcHmi.Controls.Helpers.DirectoryBrowser.DescendantItem<TcHmi.Server.RecipeManagement.RecipeType, TcHmi.Server.RecipeManagement.FolderRecipeType>[] | null): void;
    /**
    ...
    getSelectedRecipeType(): Promise<{
        name: string;
        recipeType: import("Beckhoff.TwinCAT.HMI.Framework/dist/API/Server.RecipeManagement").RecipeType;
    } | null>;
    /**
...
export declare class FileConflictPrompt extends TcHmi.Controls.Helpers.OkCancelPrompt<Map<string, string>> {
