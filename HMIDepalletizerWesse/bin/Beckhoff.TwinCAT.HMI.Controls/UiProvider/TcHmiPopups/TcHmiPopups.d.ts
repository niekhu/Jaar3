declare namespace TcHmi.Controls.UiProvider.Popup {
    class TcHmiPopups extends TcHmi.UiProvider.PopupProvider {
         ...
         */
        createMessageBox<T>(header: Localizable, content: Localizable, buttons: TcHmi.Dictionary<{
            value: T;
            width: number;
            height: number;
         ...
         * @template T A popup prompt() will result with this value type
         */
        createHtmlElementBox<T>(header: Localizable, content: HTMLElement, buttons: TcHmi.Dictionary<{
            value: T;
            width: number;
            height: number;
            widthMode?: 'Value' | 'Content';
    ...
    class MessageBox<T> extends TcHmi.UiProvider.PopupProvider.MessageBox<T> {
        ...
        constructor(header: Localizable, content: Localizable, buttons: TcHmi.Dictionary<{
            value: T;
            width: number;
            height: number;
            widthMode?: 'Value' | 'Content';
        ...
        protected __popup: TcHmi.Controls.Helpers.TextAndButtonsPrompt<T>;
         ...
         */
        setTexts(texts: Partial<TcHmi.Controls.Helpers.TextAndButtonsPrompt.LocalizableTexts>): void;
        /**
         * Sets the background action.
         * @param action
         */
        setBackgroundAction(action: TcHmi.Controls.Helpers.ButtonsPrompt.BackgroundAction<T>): void;
        /**
         * Sets the background mode of the TopMostLayer used for displaying the popup.
         * @param mode
         */
        setBackgroundMode(mode: TcHmi.Controls.Helpers.Popup.BackgroundMode): void;
        /**
         * Sets the positioning mode of the popup in the TopMostLayer.
         * @param mode
         */
        setPositioningMode(mode: TcHmi.Controls.Helpers.Popup.PositioningMode): void;
        /**
         * Sets the bounds of the popup. Does only have any effect if PositioningMode.Floating is used.
         * @param bounds
         */
        setBounds(bounds: TcHmi.Controls.Helpers.Popup.Bounds | null): void;
        /**
    ...
    class HtmlElementBox<T> extends TcHmi.UiProvider.PopupProvider.HtmlElementBox<T> {
        ...
        constructor(header: Localizable, element: HTMLElement, buttons: TcHmi.Dictionary<{
            value: T;
            width: number;
            height: number;
            widthMode?: 'Value' | 'Content';
        ...
        protected __popup: TcHmi.Controls.Helpers.HtmlAndButtonsPrompt<T>;
         ...
         * Sets texts which can either be localizable or static.
         */
        setTexts(texts: Partial<TcHmi.Controls.Helpers.ButtonsPrompt.LocalizableTexts>): void;
        /**
         * Sets the background action.
         * @param action
         */
    ...
    class InputPrompt extends TcHmi.UiProvider.PopupProvider.InputPrompt {
        ...
        protected __popup: TcHmi.Controls.Helpers.InputPrompt;
         ...
         * Sets texts which can either be localizable or static.
         */
        setTexts(texts: Partial<TcHmi.Controls.Helpers.InputPrompt.LocalizableTexts>): void;
        /**
         ...
         */
        setBackgroundAction(action: TcHmi.Controls.Helpers.Popup.BackgroundAction<'cancel' | 'ok'>): void;
        /**
         * Sets the background mode of the TopMostLayer used for displaying the popup.
         * @param mode
         */
    ...
    class InteractiveWritePrompt extends TcHmi.UiProvider.PopupProvider.InteractiveWritePrompt {
        ...
        protected __popup: TcHmi.Controls.Helpers.InteractiveWritePrompt;
        protected __closeButtonAction: TcHmi.UiProvider.PopupProvider.PromptAction<'ok' | 'cancel'> | null;
        /**
         * Destroys the popup and all its controls.
         */
