...
declare class TcHmiTextbox extends TcHmiControl.Control {
    #private;
    ...
    protected __valueBuffer: TcHmi.Controls.Helpers.ValueBuffer<string> | undefined;
    /** Localization */
...
export { TcHmiTextbox as Control };
declare const _TcHmiTextbox: typeof TcHmiTextbox;
type tTcHmiTextbox = TcHmiTextbox;
type tScrollMode = ScrollMode;
declare global {
    namespace TcHmi.Controls.Beckhoff {
        const TcHmiTextbox: typeof _TcHmiTextbox;
        type TcHmiTextbox = tTcHmiTextbox;
        type ScrollMode = tScrollMode;
    }
}
//# sourceMappingURL=TcHmiTextbox.esm.d.ts.map