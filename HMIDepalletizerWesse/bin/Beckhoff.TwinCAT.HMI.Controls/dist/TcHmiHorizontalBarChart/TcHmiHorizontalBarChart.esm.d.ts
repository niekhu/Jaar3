...
declare class TcHmiHorizontalBarChart extends TcHmiControl.Control {
    #private;
    ...
    protected __barChart: TcHmiCharting.HorizontalBarChart | null;
    ...
    /** Internal reference to the attribute 'data-tchmi-x-position' */
    protected __xPosition: keyof typeof Position | undefined;
    ...
    /** Internal reference to the attribute 'data-tchmi-x-axis-format' */
     ...
     * Possible Values: Background, Foreground
     */
     ...
     * @param valueNew The new value for xPosition
     * Possible Values: Left, Right
     */
    setXPosition(valueNew: keyof typeof Position | null): void;
    /**
     * Gets the value of xPosition
     * @returns The current value of xPosition
     */
    getXPosition(): "Left" | "Right" | undefined;
    /**
     * Processes yPosition
     */
    protected __processXPosition(): void;
    /**
     ...
     * @param yAxis The new xAxisFormat method.
     */
     ...
     */
    setGridLineStyle(valueNew: keyof typeof TcHmiCharting.IGrid.LineStyle | null): void;
    /**
...
export { TcHmiHorizontalBarChart as Control };
declare const _TcHmiHorizontalBarChart: typeof TcHmiHorizontalBarChart;
type tTcHmiHorizontalBarChart = TcHmiHorizontalBarChart;
...
type tBarGraphDescriptionInternal = BarGraphDescriptionInternal;
type tReferenceLine = ReferenceLine;
type tColorRangesEngineering = ColorRangesEngineering;
type tColorRanges = ColorRanges;
declare global {
    namespace TcHmi.Controls.Beckhoff {
        const TcHmiHorizontalBarChart: typeof _TcHmiHorizontalBarChart;
        type TcHmiHorizontalBarChart = tTcHmiHorizontalBarChart;
        namespace TcHmiHorizontalBarChart {
            ...
            type BarGraphDescriptionInternal = tBarGraphDescriptionInternal;
...
//# sourceMappingURL=TcHmiHorizontalBarChart.esm.d.ts.map